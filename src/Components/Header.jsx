...
function Header() {
  ...
  return (
    <>
      ...
      <Container>
        <Navbar.Brand ><Link to ={'/'} style={{color:"white",fontSize:'30px',fontWeight:'bolder', textDecoration:'none'}}> <i class="fa-solid fa-truck fa-bounce"></i> E-Cart </Link></Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            <Nav.Link><Link to = {'/cart'}  style={{color:'white',fontSize:'20px', textDecoration:'none'}}>Cart  <i class="fa-solid fa-cart-shopping text-success"></i> 
